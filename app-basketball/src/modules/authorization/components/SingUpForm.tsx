            ...
            <Container >
                <FormContainer >
                    ...
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        <Input id='nameUp' title={'Name'} {...register('userName',{ required: 'Name required'})} error={errors.userName?.message} />
                        <Input  id='loginUp' title={'Login'} {...register('login', { required: 'Login required'})} error={errors.login?.message}/>
                        <Input id='passwordUp' title={'Password'} type="password" {...register('password', { required: 'Password required',
                            minLength : {
                                value: 3,
                                message: 'Password must contain at least 3 characters'
                            }
                        })} error={errors.password?.message}/>
                        <Input id='passwAgain' title={'Enter your password again'} type="password" {...register('confirmPassword',
